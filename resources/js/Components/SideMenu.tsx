    ...
    return(
        ...
        <div className={`flex flex-col justify-between border-e bg-white ${showElement ? 'esconde hidden':'mostra block'}`}>
            ...
            <div className="h-screen w-[250px] px-4 py-6 print:hidden">
                <p className='text-black text-2xl font-bold text-center'>Title</p>
                <ul className="mt-6 space-y-1">
                    ...
                    <li>
                        <details className="group [&_summary::-webkit-details-marker]:hidden">
                            <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                <span className="text-base font-bold"> Encomendas </span>
                            ...
                            <ul className="mt-2 space-y-1 px-4">
                                <li>
                                    <a href="/formcadastrarencomendas" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                        Cadastrar Encomenda
                                    </a>
                                </li>
                                <li>
                                    <a href="/encomendas" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700" >
                                        Listar Encomendas
                                    </a>
                                </li>
                                <li>
                                    <a href="/pedidos" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700" >
                                        Listar Pedidos
                                    </a>
                                </li>
                                <li>
                                    <a href="/ifood" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                        Ifood
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li>
                        <details className="group [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <ul className="mt-2 space-y-1 px-4">
                                <li>
                                    <a href="/listarcardapios" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                        Listar
                                    </a>
                                </li>
                                <li>
                                    <a href="/formcadastracardapio" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700" >
                                        Cadastrar
                                    </a>
                                </li>
                                <li>

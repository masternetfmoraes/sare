export default function CardapioAtualizadoSucesso(){
    return(
        <>
        <div className="max-w-1xl mx-auto sm:px-6 lg:px-8 p-12">
            <div className="bg-white overflow-hidden text-center shadow-sm sm:rounded-lg">
                <p className="text-6xl pt-12 text-green-600">Sucesso!!</p>
                <p className="p-6 text-green-900 text-xl ">Cardapio atualizado com sucesso!</p>
